                ...
                <div class="row">
                    <div class="col-12 mr-auto">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="entry form-control" name="title" id="title" aria-describedby="title" value="<?php echo $_POST['title'] ?? $data['title']; ?>" placeholder="Enter post title here" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" rows=10 class="form-control" name="contents" id="summernote" aria-describedby="contents" placeholder="Type pot contents here here"><?php echo $_POST['contents'] ?? $data['contents']; ?></textarea>
                        </div>
